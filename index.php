...
<main class="min-h-[calc(100vh-64px)] flex items-center justify-center bg-gray-900 text-white px-4">
  <div class="text-center space-y-4">
    <h1 class="text-4xl md:text-5xl font-bold">Welcome to <span class="text-blue-500">Aver-Web</span></h1>
    <p class="text-gray-300 text-lg max-w-xl mx-auto">Your personal AI assistant with memory, chat history, and advanced chat-tools – all in one place.</p>
